...
$R['faq_admin_onepage'] = '{$title} &nbsp; <input {$checked} type="checkbox" value="{$value}" name="{$name}" />';
$R['faq_admin_delete_link'] = '<a href="{$url}">'.$L['Delete'].'</a>';
$R['faq_admin_update_link'] = '<a href="{$url}">'.$L['Update'].'</a>';